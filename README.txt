...
2. "One-time setup" এ:
   ...
   - "Save setup" চাপুন
3. এরপর:
   - "Site text" এ নাম, ট্যাগলাইন, ফোন নাম্বার বসান
   - "Book Now link" ঘরে আপনি যেই লিংকে মানুষকে নিয়ে যেতে চান সেটা বসান —
     এটা যেকোনো লিংক হতে পারে: আপনার অন্য ওয়েবসাইট, একটা ফর্ম, Calendly,
     WhatsApp, Instagram — যা খুশি। বড় "Book Now" বাটন সবসময় এই লিংকেই যাবে।
   - নিচে WhatsApp/Instagram/Email এগুলো আলাদা, ছোট লিংক হিসেবে দেখাবে
     (এগুলো খালি রাখলে সাইটে দেখাবে না)
   - সব শেষে "Save text" চাপুন
